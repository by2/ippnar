 ...
 * Tabsize: 4
 * Copyright: (c) 2009 by Dejan Levec
 * License: GNU GPL v2 (see License.txt), GNU GPL v3 or proprietary (CommercialLicense.txt)
 */

#ifndef __usbconfig2_h_included__
#define __usbconfig2_h_included__
 ...
 */
#define USB_CFG_VENDOR_NAME     'u', 'f', 'o', 'b', 'u', 'i', 'l', 'd', 'e', 'r', 's'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'C', 'o', 'm', 'p', 'a', 's', 's'
...
#endif /* __usbconfig2_h_included__ */
